...
insert into answers(data, question_id, quality) values ('It is a conglomeration of networks', 1, 'decent');
insert into answers(data, question_id, quality) values ('Communication with the same protocols', 1, 'decent');
...
insert into answers(data, question_id, quality) values ('Around the 150 dollars', 2, 'decent');
insert into answers(data, question_id, quality) values ('It is over 100 dollars', 2, 'decent');
...
insert into answers(data, question_id, quality) values ('I believe it was Russia', 3, 'decent');
insert into answers(data, question_id, quality) values ('I guess the main initiator is Russia', 3, 'decent');
...
insert into answers(data, question_id, quality) values ('At least 1 bottle', 4, 'decent');
insert into answers(data, question_id, quality) values ('At least 1.5 liters', 4, 'decent');
...
insert into answers(data, question_id, quality) values ('Science about control and communication with machines', 5, 'decent');
insert into answers(data, question_id, quality) values ('It is study of feedback mechanism', 5, 'decent');
